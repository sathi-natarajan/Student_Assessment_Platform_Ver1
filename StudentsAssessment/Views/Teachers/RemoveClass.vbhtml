...
<script language="javascript" type="text/javascript">
    $(document).ready(function () {
        //alert($('#SelectedClass').length)
        //if($('#SelectedClass').length==1)
        //    $('#btnRemove').attr("class") = "btn btn-success disabled";
        //else
            ...
            @Using (Html.BeginForm())
                ...
                @<table id="tblCreateClass" border="0" cellpadding="2" cellspacing="2" style="margin-top:-40px;">
                    ...
                    <tr>
                        ...
                        <td>
                            @Html.DropDownListFor(Function(model) model.SelectedClass, Model.TaughtClassesList, New With {.onchange = "FillClassData();"})
